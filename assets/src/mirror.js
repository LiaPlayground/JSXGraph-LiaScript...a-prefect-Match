...
var ph2 = view.create(
  'polyhedron3d',
  [ph1, [tr1, tr2, tr3, tr4, trX, trY, trZ, tr1]],
  {
    fillColorArray: [
      '#0072b2',
      '#e69f00',
...
function initBoard3D(b) {
  ...
  let v = b.create(
    ...
    [
      ...
      [10, 10],
      [
        [input['coordinates']['-x'], input['coordinates']['+x']],
        [input['coordinates']['-y'], input['coordinates']['+y']],
        [input['coordinates']['-z'], input['coordinates']['+z']],
      ],
    ],
    {
      ...
      xAxis: {
        visible: input['axis']['x'],
        strokeColor: '#888888',
        strokeWidth: 2,
      },
      yAxis: {
        visible: input['axis']['y'],
        strokeColor: '#888888',
        strokeWidth: 2,
      },
      zAxis: {
        visible: input['axis']['z'],
        strokeColor: '#888888',
        strokeWidth: 2,
      },
      ...
      xPlaneRear: {
        ...
        mesh3d: {
          visible: input['planeRear']['x'] & input['planeRear']['mesh'],
        },
        fillColor: input['planeRear']['x']
          ? input['planeRear']['color']
          : 'none',
      },
      yPlaneRear: {
        ...
        strokeWidth: input['planeRear']['border'],
        mesh3d: {
          visible: input['planeRear']['y'] & input['planeRear']['mesh'],
        },
        fillColor: input['planeRear']['y']
          ? input['planeRear']['color']
          : 'none',
      },
      zPlaneRear: {
        ...
        strokeWidth: input['planeRear']['border'],
        mesh3d: {
          visible: input['planeRear']['z'] & input['planeRear']['mesh'],
        },
        fillColor: input['planeRear']['z']
          ? input['planeRear']['color']
          : 'none',
      },
      xPlaneFront: {
        ...
        mesh3d: {
          visible: input['planeFront']['x'] & input['planeFront']['mesh'],
        },
        fillColor: input['planeFront']['x']
          ? input['planeFront']['color']
          : 'none',
      },
      yPlaneFront: {
        ...
        strokeWidth: input['planeFront']['border'],
        mesh3d: {
          visible: input['planeFront']['y'] & input['planeFront']['mesh'],
        },
        fillColor: input['planeFront']['y']
          ? input['planeFront']['color']
          : 'none',
      },
      zPlaneFront: {
        ...
        strokeWidth: input['planeFront']['border'],
        mesh3d: {
          visible: input['planeFront']['z'] & input['planeFront']['mesh'],
        },
        fillColor: input['planeFront']['z']
          ? input['planeFront']['color']
          : 'none',
      },
      ...
      // Axes on planes
      xPlaneRearYAxis: {
        visible: input['planeRear']['x'] & input['planeRear']['axis'],
      },
      xPlaneRearZAxis: {
        visible: input['planeRear']['x'] & input['planeRear']['axis'],
      },
      yPlaneRearXAxis: {
        visible: input['planeRear']['y'] & input['planeRear']['axis'],
      },
      yPlaneRearZAxis: {
        visible: input['planeRear']['y'] & input['planeRear']['axis'],
      },
      zPlaneRearXAxis: {
        visible: input['planeRear']['z'] & input['planeRear']['axis'],
      },
      zPlaneRearYAxis: {
        visible: input['planeRear']['z'] & input['planeRear']['axis'],
      },
      xPlaneFrontYAxis: {
        visible: input['planeFront']['x'] & input['planeFront']['axis'],
      },
      xPlaneFrontZAxis: {
        visible: input['planeFront']['x'] & input['planeFront']['axis'],
      },
      yPlaneFrontXAxis: {
        visible: input['planeFront']['y'] & input['planeFront']['axis'],
      },
      yPlaneFrontZAxis: {
        visible: input['planeFront']['y'] & input['planeFront']['axis'],
      },
      zPlaneFrontXAxis: {
        visible: input['planeFront']['z'] & input['planeFront']['axis'],
      },
      zPlaneFrontYAxis: {
        visible: input['planeFront']['z'] & input['planeFront']['axis'],
      },
  ...
  v.el_slide.setAttribute({
    snapValues: [-Math.PI, -Math.PI / 2, 0, Math.PI / 2, Math.PI].concat(
      input['view']['elevation']
    ),
  })
  v.el_slide.name = 'EL'
  ...
  v.az_slide.setAttribute({
    snapValues: [0, Math.PI / 2, Math.PI, Math.PI * 1.5, Math.PI * 2].concat(
      input['view']['azimuth']
    ),
  })
  v.az_slide.name = 'AZ'
  ...
  v.bank_slide.setAttribute({
    snapValues: [-Math.PI, -Math.PI / 2, 0, Math.PI / 2, Math.PI],
  })
...
function sliderAttr() {
  let slA = {
    ...
    label: {
      ...
      layer: 0,
      cssStyle:
        'border: 0px solid red; padding: 1px 8px 1px 8px; border-radius: 20px;background-color: #f2f2f2',
    },
    size: 7,
...
function elAttr() {
  let elA = {
    label: {
      ...
      layer: 0,
      cssStyle:
        'border: 0px solid red; padding: 1px 8px 1px 8px; border-radius: 20px;background-color: #f2f2f2; white-space: nowrap;',
    },
  }
  return elA
}
